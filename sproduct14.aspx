<%@ Page Language="C#" AutoEventWireup="true" CodeFile="sproduct14.aspx.cs" Inherits="sproduct14" %>
...
<body>
        ...
        <div class="navbar">
            ...
            <div class="navitem">
                <div class="search">
                    ...
                    <a href="login.html"><img src="img/sig.png" alt="" width="40px" class="sign"></a>
    ...
    <div class="prodetails">
        <img src="img/S14.png" width="100%" alt="">
    <div class="sprodetails">
        ...
        <span>This is a gentleman suit</span>
    </div>
</div>
    ...
    <div class="pro-container">
        ...
        <div class="pro">
            ...
            <h5>Groupon Yellow Designer Shirt</h5>
            <div class="star">
                <i class="fas fa-star"></i>
                <i class="fas fa-star"></i>
                <i class="fas fa-star"></i>
